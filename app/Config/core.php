 ...
 */
	...
	Configure::write('App.Version', '1.0.0');
	Configure::write('Security.level', 'medium');
	Configure::write('Locale', 'it');
 ...
 */
	Configure::write('Session', array(
	    ...
	    'checkAgent' => false,
	    'autoRegenerate' => true, // causes the session expiration time to reset on each page load, but also causes 403 errors on ajax requests, therefore disabled
			*/
	));
/**
